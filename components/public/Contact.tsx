      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-secondary-900 mb-6 text-center">{t('contact.info.title')}</h3>
            ...
            <div className="space-y-6">
              {/* Email */}
              <div className="flex items-start gap-4 bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-100 hover:shadow-lg transition-all">
              ...
              <div className="flex items-start gap-4 bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-100 hover:shadow-lg transition-all">
                ...
                <div className="flex-1">
                  ...
                  <a href="tel:+79315390543" className="text-gray-600 hover:text-primary-500 transition-colors">
                    +7 931 539 0543
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-100 hover:shadow-lg transition-all">
                ...
                <div className="flex-1">
                  ...
                  <a href="https://wa.me/79315390543" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600 transition-colors">
                    +7 931 539 0543
                  </a>
                </div>
              </div>
