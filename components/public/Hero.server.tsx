        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8 z-10 pt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#pricing"
                className="border-2 border-secondary-900 text-secondary-900 px-8 py-4 rounded-lg font-semibold hover:bg-secondary-900 hover:text-white transition-all duration-300 text-center"
              >
                {t('hero.pricing')}
              </a>
            </div>
